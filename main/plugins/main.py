...
async def clone(bot, event):
    try:
        ...
        return
    edit = await bot.send_message(event.chat.id, 'Sedang Upload.')
    if 't.me/+' in link:
    ...
    if 't.me' in link:
        try:
            ...
            return await edit.edit('Terlalu Banyak Permintaan, Coba Lagi Nanti!')
        except ValueError:
            return await edit.edit('Kirim Hanya Link Pesan atau Undangan Channel Pribadi.')
        except Exception as e:
